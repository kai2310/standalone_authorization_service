...
/**
 */
public class AccountIdQueryBuilder extends AbstractEntityJpaQueryBuilder<PersistentAccountGroup>
{
                                    ...
                                    List<String> arguments, PersistenceContext context)
    {
        ...
        Root idRoot = idQuery.from(PersistentAccountGroup.class);
        idQuery.select(idRoot.get("id"));
        ListJoin idFrom = idRoot.joinList("accountIds");
